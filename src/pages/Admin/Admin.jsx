...
const Admin = () => {
  ...
  const [{ pagingItems, data: users, pageRange, page }, setData] =
    usePagination([]);
  ...
  const hanldeUpdate = (id, data) => {
    ...
    if (id !== "0") {
      ...
      adminServices.addAdmin(data).then((res) => {
        if (res.success) {
          toast.success(t("confirmsuccess"), {
            onClose: () => loadData(page),
          });
  ...
  const attribute = {
    pageTitle: t("adminAccount"),
    enableAdd: true,
    pagingItems,
    data: users,
    pageRange,
    title: [t("fullname"), t("phone"), t("email"), t("username"), t("address")],
  };
            ...
            <div className="col-sm-9">
              <div className="row mb-3 d-flex justify-content-center">
                <div className="col-sm-6 col-lg-6">
                  <label htmlFor="txtCity" className="row mb-1 ms-0">
                    {t("city")}
                  </label>
                  <input
                    type="text"
                    className="row form-control ms-0 "
                    id="txtCity"
                    placeholder={t("city")}
                    name="city"
                ...
                <div className="col-sm-6 col-lg-6">
                  <label htmlFor="txtStreet" className="row mb-1 ms-0">
                    {t("street")}
                  </label>
                  <input
                    type="text"
              ...
              <div className="row mb-3">
                <div className="col-sm-6 col-lg-6">
                  <label htmlFor="txtNumber" className="row mb-1 ms-0">
                    {t("number")}
                  </label>
                  <input
                    type="text"
